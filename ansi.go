...
func render(value string) string {
	return (escPrefix + value)
}

func EraseDisplay(code int) string {
	return render(strconv.Itoa(code) + "2J")
}

func EraseLine(code int) string {
	return render(strconv.Itoa(code) + "K")
}
...
func CursorUp(n int) string {
	return render(strconv.Itoa(n) + "A")
}

func CursorDown(n int) string {
	return render(strconv.Itoa(n) + "B")
}

func CursorForward(n int) string {
	return render(strconv.Itoa(n) + "C")
}

func CursorBackward(n int) string {
	return render(strconv.Itoa(n) + "D")
}

func CursorStart(n int) string {
	return render(strconv.Itoa(n) + "G")
}
